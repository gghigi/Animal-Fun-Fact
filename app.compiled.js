...
function displayFact(e) {
  var selectedAnimals = e.target.alt;
  var animalsInfo = _animals.animals[selectedAnimals];
  var optionIndex = Math.floor(Math.random() * animalsInfo.facts.length);

  var funFact = animalsInfo.facts[optionIndex];
